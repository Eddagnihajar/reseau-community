  ...
  <div id="app">
    ...
    <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown dropdown-list-toggle"><a href="ev_etud.jsp" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="fas fa-calendar-alt"></i></a>
            <div class="dropdown-menu dropdown-list dropdown-menu-right">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#"><i class="fas fa-fire"></i><span>Groupes</span></a>
              </li>
              <li >
                <a href="#" class="nav-link"><i class="fas fa-fire"></i><span>Club</span></a>
              </li>
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" ><i class="fas fa-fire"></i> <span>Offres</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="#">Offre emploi</a></li>
                  <li><a class="nav-link" href="#">Offre stage </a></li>
                </ul>
              </li>
              <li><a href="#"><i class="fas fa-fire"></i> <span>Evenements</span></a></li>
              <li><a  href="#"><i class="fas fa-fire"></i> <span>Hash-Tag</span></a></li>
              ...
              <div class="col-12 col-md-4 col-lg-4">
                <article class="article article-style-c">
                  ...
                  <div class="article-details">
                    ...
                    <p>l'evenement ***********************. </p>
                     <button type="submit" class="btn btn-primary btn-lg btn-block" >Rejoindre</button>
