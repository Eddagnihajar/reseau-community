...
<head>
  ...
  <title>Inscription d'entreprise &mdash; FSBM-Community</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>inscription d'entreprise</h4></div>

              <div class="card-body">
                <form method="post" action="inscription_entreprise">
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input id="email" type="number" class="form-control" name="tele">
                    <div class="invalid-feedback">
                    </div>
                  </div>
                   <div class="form-group">
                    <label for="email">votre temp disponibilite</label>
                    <input id="email" type="number" class="form-control" name="tempdispo">
                    <div class="invalid-feedback">
                    </div>
                  </div>
                  <div class="form-group">
